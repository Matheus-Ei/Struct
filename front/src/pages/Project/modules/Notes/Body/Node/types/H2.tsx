...
const H2 = ({ id, content, next_id }: NodeElementType) => {
  ...
  const css = clsx(
    'w-full h-auto px-2 py-0.5 resize-none outline-none cursor-text min-h-[1.8em] flex items-center font-bold text-2xl',
  );
